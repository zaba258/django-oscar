...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingAddress.phone_number'
        db.alter_column(u'order_shippingaddress', 'phone_number', self.gf('oscar.models.fields.PhoneNumberField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'ShippingAddress.phone_number'
        db.alter_column(u'order_shippingaddress', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
    ...
    models = {
        ...
        u'order.shippingaddress': {
            ...
            'phone_number': ('oscar.models.fields.PhoneNumberField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'postcode': ('oscar.models.fields.UppercaseCharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'search_text': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
            'state': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'})
